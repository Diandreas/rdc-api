        ...
        <aside id="sidebar" class="sidebar-transition bg-white dark:bg-gray-800 shadow-lg w-64 fixed h-full z-30 sidebar-mobile">
            ...
            <nav class="mt-4">
                ...
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="{{ route('admin.storage.index') }}" class="flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-gray-700 hover:text-blue-600 dark:hover:text-blue-400 {{ request()->routeIs('admin.storage*') ? 'bg-blue-50 dark:bg-gray-700 text-blue-600 dark:text-blue-400' : '' }}">
